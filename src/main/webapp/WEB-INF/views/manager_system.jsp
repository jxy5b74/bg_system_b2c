...
<script type="text/javascript">
	...
	$(function(){
		...
		if(bg_tags == "sku_redis"){
			document_node =document.getElementById("bg_system_adjust_spu_redis_cache_info.do");
		}
		...
		<li>
			...
			<ul>				
				...
				<li data-options="state:'open'">
					<span>Redis数据缓存</span>
					<ul>
						<li><a href="#">用户登录信息缓存</a></li>
						<li><a href="javascript:;" id="bg_system_adjust_spu_redis_cache_info.do" onclick="bg_add_spu_info_tab(this)">商品分类属性信息缓存</a></li>
					</ul>
				</li>
			</ul>
		</li>
